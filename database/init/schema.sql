-- MiniCloud Management Console - Comprehensive MySQL Schema
...
CREATE TABLE IF NOT EXISTS load_balancers (
    ...
    type VARCHAR(20), -- application, network
    scheme VARCHAR(20), -- internet-facing, internal
    status VARCHAR(20),
    vpc_id VARCHAR(50),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
